  ...
  return (
    <header className="w-full py-5 sm:px-10 px-5 flex justify-center items-center">
      <nav className="flex w-full screen-max-width">
        <Image src={appleImg} alt="apple-image" width={14} height={18} />
        ...
        <div className="flex items-baseline gap-7 max-sm:justify-end max-sm:flex-1">
          <Image src={searchImg} alt="seach-bar" width={18} height={18} />
          <Image src={bagImg} alt="seach-bar" width={18} height={18} />
        </div>
      </nav>
    </header>
  );
